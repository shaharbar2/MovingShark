...
Shader "Shark/animated/displacement" {
	...
	SubShader{
		...
		Pass{
			...
			fixed4 frag(VertexToFragment i) : COLOR{
				...
				_HeightMap1ScrollU = _HeightMapStrength * _SinTime;
				_HeightMap1ScrollV = _HeightMapStrength * _CosTime;
				...
				return fixed4((background1.r*alpha),(background1.g*alpha),(background1.b*alpha),alpha) * i.colorMulti;
